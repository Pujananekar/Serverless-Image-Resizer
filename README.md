...
2. Create two buckets:
   - `my-original-images-puja` (for uploads)

### S3 Buckets
![S3 Buckets](images/s3.png)

   - `my-resized-images-puja` (for processed images)
...
### Lambda Function
![Lambda](images/lambda_function.png)
...
def lambda_handler(event, context):
    ...
    target_bucket = 'my-resized-images-puja'
    ...
    "Statement": [
        {
            ...
            "Principal": "*",
            "Action": "s3:GetObject",
            "Resource": "arn:aws:s3:::my-resized-images-puja/*"
        }
    ]
}
```
...
### Resized Images
![Results](images/resized-img.png)
...
**Pooja Nanekar**
- GitHub: [@pujananekar](https://github.com/pujananekar)
- LinkedIn: [Nanekar Puja](https://linkedin.com/in/yourprofile)
- Email: nanekarpuja19@gmail.com